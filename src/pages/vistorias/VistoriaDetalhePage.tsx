...
export function VistoriaDetalhePage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      alert('Ocorreu um erro ao excluir a vistoria. Por favor, tente novamente.');
    } finally {
      setIsDeleting(false);
    }
  };
  ...
  const handleStartInspection = async () => {
    ...
    try {
      ...
      alert('Ocorreu um erro ao iniciar a vistoria. Por favor, tente novamente.');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div>
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Detalhes da Vistoria</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-base text-gray-900">
                  {format(new Date(vistoria.data), "dd 'de' MMMM 'de' yyyy 'às' HH:mm", { locale: ptBR })}
                </p>
              </div>
              <div>
              ...
              <div>
                <p className="text-sm font-medium text-gray-500">Unidade Regional</p>
                <p className="text-base text-gray-900">{vistoria.unidadeRegional}</p>
              </div>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <p className="text-sm font-medium text-gray-500">Modelo de Telha</p>
                  <p className="text-base text-gray-900">{vistoria.modeloTelha || 'Não informado'}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Espessura</p>
                  <p className="text-base text-gray-900">{vistoria.espessura || 'Não informada'}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Tecnologia</p>
                  <p className="text-base text-gray-900">{vistoria.tecnologia || 'Não informada'}</p>
                </div>
                {vistoria.quantidadeTelhas && (
                  <div>
                    <p className="text-sm font-medium text-gray-500">Quantidade de Telhas</p>
                    <p className="text-base text-gray-900">{vistoria.quantidadeTelhas}</p>
                  </div>
                )}
                {vistoria.areaCoberta && (
                  <div>
                    <p className="text-sm font-medium text-gray-500">Área Coberta</p>
                    <p className="text-base text-gray-900">{vistoria.areaCoberta} m²</p>
                  </div>
                )}
              </div>
            </div>
            ...
            {vistoria.observacoes && (
              <div className="mt-6">
                ...
                <p className="text-gray-700 whitespace-pre-line">{vistoria.observacoes}</p>
              </div>
            )}
            ...
            {/* Não Conformidades */}
            {vistoria.naoConformidades && vistoria.naoConformidades.length > 0 && (
              <div className="mt-6">
                <h3 className="text-md font-semibold text-gray-800 mb-2">
                  ...
                  {vistoria.naoConformidades.map((nc, index) => (
                    <div key={nc.id} className="border border-gray-200 rounded-lg p-4">
                      <div className="flex justify-between items-start mb-2">
                        <h4 className="font-medium">Não Conformidade #{index + 1}</h4>
                        <span className={cn(
                          "px-2 py-1 text-xs rounded-full",
                          nc.confirmada ? "bg-red-100 text-red-800" : "bg-yellow-100 text-yellow-800"
                        )}>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-base text-gray-900">{nc.descricao}</p>
                        </div>
                      </div>
                      {nc.observacoes && (
                        <div className="mt-2">
                          <p className="text-sm font-medium text-gray-500">Observações</p>
                          <p className="text-base text-gray-900">{nc.observacoes}</p>
                        </div>
                      )}
                    </div>
                  ))}
            ...
            {(vistoria.assinaturaTecnico || vistoria.assinaturaCliente) && (
              <div className="mt-6">
                <h3 className="text-md font-semibold text-gray-800 mb-2">Assinaturas</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {vistoria.assinaturaTecnico && (
                    <div>
                      <p className="text-sm font-medium text-gray-500 mb-2">Assinatura do Técnico</p>
                      <img 
                  ...
                  {vistoria.assinaturaCliente && (
                    <div>
                      <p className="text-sm font-medium text-gray-500 mb-2">Assinatura do Cliente</p>
                      <img 
        ...
        <div className="lg:col-span-1 space-y-6">
          {/* Status e Ações */}
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">Status e Ações</h2>
              ...
              <div className="flex items-center">
                <div className="relative flex items-center justify-center">
                  <div className={cn(
                    ...
                    vistoria.status === 'em_andamento' ? "bg-yellow-100 text-yellow-600" :
                    vistoria.status === 'concluida' ? "bg-green-100 text-green-600" :
                ...
                <div className="ml-4">
                  ...
                  <p className="text-xs text-gray-500">
                    {format(new Date(vistoria.dataModificacao), "dd/MM/yyyy 'às' HH:mm")}
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-3 text-sm">
              <div>
                ...
                <p className="font-medium">
                  {format(new Date(vistoria.dataCriacao), "dd/MM/yyyy 'às' HH:mm")}
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <div className={cn(
                  ...
                  vistoria.sincronizado ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"
                )}>
                  {vistoria.sincronizado ? (
                    <>
