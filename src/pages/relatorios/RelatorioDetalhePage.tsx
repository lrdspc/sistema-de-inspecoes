    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (relatorioData) {
          ...
          const vistoriaData = await db.get('vistorias', relatorioData.vistoriaId);
          if (vistoriaData) {
  ...
  if (!relatorio || !vistoria || !cliente) {
    return (
      <div className="p-6 bg-white rounded-lg shadow-sm text-center">
        <h2 className="text-xl font-semibold text-gray-800 mb-2">Relatório não encontrado</h2>
  ...
  return (
    <div>
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Relatório Técnico</h1>
        ...
        <div className="lg:col-span-2">
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-semibold text-gray-900">{relatorio.titulo}</h2>
            ...
            <div className="prose max-w-none">
              <section className="mb-8">
                <h3 className="text-lg font-semibold text-gray-800 mb-3">Introdução</h3>
              ...
              <section className="mb-8">
                <h3 className="text-lg font-semibold text-gray-800 mb-3">Análise Técnica</h3>
                <div className="text-gray-700 whitespace-pre-line">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-base text-gray-900">
                  {format(new Date(relatorio.dataCriacao), "dd 'de' MMMM 'de' yyyy", { locale: ptBR })}
                </p>
              </div>
              
              {relatorio.dataFinalizacao && (
                <div>
                  <p className="text-sm font-medium text-gray-500">Data de Finalização</p>
                  <p className="text-base text-gray-900">
                    {format(new Date(relatorio.dataFinalizacao), "dd 'de' MMMM 'de' yyyy", { locale: ptBR })}
                  </p>
                </div>
              )}
              
              <div>
                <p className="text-sm font-medium text-gray-500">Status de Sincronização</p>
                <div className={cn(
                  "mt-1 px-2 py-1 rounded-full text-xs inline-flex items-center",
                  relatorio.sincronizado ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"
                )}>
